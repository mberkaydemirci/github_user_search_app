...
class Items {
  ...
  bool? _siteAdmin;
  double? _score;
  List<Text_matches>? _textMatches;
  ...
  List<Text_matches>? get textMatches => _textMatches;
  ...
  Items.fromJson(dynamic json) {
    ...
    _score = json['score'];
    if (json['text_matches'] != null) {
      _textMatches = [];
      json['text_matches'].forEach((v) {
        _textMatches?.add(Text_matches.fromJson(v));
      });
    }
  }
  ...
  @override
  String toString() {
    return 'Items{_login: $_login, _id: $_id, _nodeId: $_nodeId, _avatarUrl: $_avatarUrl, _gravatarId: $_gravatarId, _url: $_url, _htmlUrl: $_htmlUrl, _followersUrl: $_followersUrl, _followingUrl: $_followingUrl, _gistsUrl: $_gistsUrl, _starredUrl: $_starredUrl, _subscriptionsUrl: $_subscriptionsUrl, _organizationsUrl: $_organizationsUrl, _reposUrl: $_reposUrl, _eventsUrl: $_eventsUrl, _receivedEventsUrl: $_receivedEventsUrl, _type: $_type, _siteAdmin: $_siteAdmin, _score: $_score, _textMatches: $_textMatches}';
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_textMatches != null) {
      map['text_matches'] = _textMatches?.map((v) => v.toJson()).toList();
    }
    return map;
  }
